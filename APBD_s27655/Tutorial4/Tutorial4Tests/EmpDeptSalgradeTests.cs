...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(g => new { g.Key, Count = g.Count() }).ToList(); 
    ...
    public void ShouldReturnEmployeesWithCommission()
    {
        ...
        var result = emps.Where(e => e.Comm != null).Select(e => new { e.EName, Comm = e.Comm }).ToList(); 
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(g => new { g.Key, AvgSal = g.Average(e => e.Sal) }).ToList(); 
